...
#ifndef PROJECT_CSIM_DIRECTORYCACHECONTROLLER_H
#define PROJECT_CSIM_DIRECTORYCACHECONTROLLER_H
...
class DirectoryCacheController: public NodeController {
private:
    int id;
    ...
    const CoherenceType coherenceType = DIRECTORY;
    int processorID;
    Cache cache;
...
public:
    DirectoryCacheController(int s, int E, int b, int processorID,
...
#endif //PROJECT_CSIM_DIRECTORYCACHECONTROLLER_H
